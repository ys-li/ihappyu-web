...
"></a></div>
        ...
        <div class="container">
            <div class="text-center" style="position: relative; padding-top: 160px; "><h2>The cards have been passed down <span id="countdis">0</span> times.</h2></div>
                    ...
                    <div class="hero-content text-center">
                        ...
                        <div class="col-md-7"><!-- style="width: 60%;display: table-cell;">-->
                                    <div style="height:300px;">
                                        ...
                                        <div id="cardfront" class ="shadowleft" style="opacity:0;width:350px; max-width:90%; height: 226px; position:relative;background-image: url('img/cards/front.jpg');background-repeat:no-repeat; background-size: contain;height: auto;z-index: 9;
                                          margin: 0 auto;'">
                                        <div id="cardback" class ="shadowleft" style="opacity:0;width:350px; max-width:100%; height: 226px;position:relative;left:30px;top:30px;background-image : url('img/cards/back.jpg');background-repeat:no-repeat;background-size: contain;z-index: 10;"></div>
    ...
    margin: 0 auto;" alt="Chat Screen" />
                ...
                <div class="col-md-6 intro-feature wp2">
                    <div class="intro-content">
                        ...
                        <p>The main objective of iHappyU Card is to provide an alternative way to connect you to people you treasure and to those who make you feel treasured. Using iHappyU card, you may send them your blessings with words of encouragement. You may show your gratitude for the good memories you shared. But most importantly, you are telling your friends that you treasure and care about them so much that you are always willing to listen to them and accompany them.</p>
                    </div>
                    <div class="intro-content">
                        <h5>PAY IT FORWARD</h5>
                        <p>The concept of Pay it Forward is crucial to iHappyU. We highly encourage you to keep passing on the card so that the love and care carried by the cards could be continued. As the cards go through hands of different people, more messages would be added together. With all these messages, we hope to create a synergistic effect where happiness can be accumulated, shared and multiplied. Let’s keep the spirit going!</p>
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="features-extra section-padding fs" style="background-color: #EEEEEE;">
            ...
            <div class="row">
                ...
                <div class="col-md-4 intro-feature wp7">
                    ...
                    <div class="intro-content last">
                        <h5>Pass the card</h5>
                        <p>Give the card to your friend physically.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="col-sm-4"><div class="circular" style="background-image: url('img/team/neil.jpg')"></div><div class="circular-text">Neil Chan<br>HKU<br>Convener (Executive)</div></div>
...
<div class="col-sm-3"><div class="circular" style="background-image: url('img/team/joyce.jpg')"></div><div class="circular-text">Joyce Mok<br>CUHK</div></div>
<div class="col-sm-3"><div class="circular" style="background-image: url('img/team/martin.jpg')"></div><div class="circular-text">Martin Ng<br>PolyU</div></div>
...
<div class="row">
                <div class="col-md-12">
                    <div class="flexslider">
                        <ul class="slides">
                            <li>
                                <div><div class="circular" style="background-image: url('img/team/neil.jpg')"></div><div class="circular-text">Neil Chan<br>HKU<br>Convener (Executive)</div></div>
                            </li>
                            <li>
                                <div><div class="circular" style="background-image: url('img/team/sumlik.jpg')"></div><div class="circular-text">Sum Lik Cheung<br>HKU<br>Co-founder (Operational)</div></div>
                            </li>
                            <li>
                                <div><div class="circular" style="background-image: url('img/team/yal.jpg')"></div><div class="circular-text">Yalsin Li<br>HKU<br>Co-founder (Technology)</div></div>
                            </li>
                            <li>
                                <div><div class="circular" style="background-image: url('img/team/gary.jpg')"></div><div class="circular-text">Gary Fung<br>CUHK</div></div>
                            </li>
                            <li>
                                <div><div class="circular" style="background-image: url('img/team/joyce.jpg')"></div><div class="circular-text">Joyce Mok<br>CUHK</div></div>
                            </li>
                            <li>
                                <div><div class="circular" style="background-image: url('img/team/martin.jpg')"></div><div class="circular-text">Martin Ng<br>PolyU</div></div>
                            </li>
                            <li>
                                <div><div class="circular" style="background-image: url('img/team/tony.jpg')"></div><div class="circular-text">Tony Lam<br>UCLA</div></div>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div >
                    <h3>Want to know more?</h3>
                        ...
                        <div class="intro-content">
                        <h5>Contact Us</h5>
                            <p><i class="fa fa-envelope"></i> admin@ihappyu.org</p>
                        </div>
